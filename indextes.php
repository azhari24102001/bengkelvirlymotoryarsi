...
<body>
    ...
    <div class="container">
        <br>
        <a href="https://wa.me/08777165392" class="btn btn-primary" style="float: right;">Kontak Kami</a>
        <br>
        <br>
        <h1 align="center">Selamat datang di website Bengkel Virly Motor</h1>
        <br></br>
        ...
        <div class="row">
    <!-- Data mobil diambil dari database menggunakan query SELECT * FROM mobil where kategori=3 AND stok > 0 ORDER BY id DESC LIMIT 4. -->
    <?php $ambil = $koneksi->query("SELECT * FROM mobil where kategori=3 AND stok > -1 ORDER BY id DESC LIMIT 4"); ?>

    <!-- Setiap mobil ditampilkan dalam loop while dan informasi seperti nama, harga, kondisi, dan tombol "Beli" ditampilkan. -->
    ...
    <div class="col-md-3">
        <div class="thumbnail">
            ...
            <div class="caption">
                ...
                <h5>Kondisi: <?php echo ucfirst($perproduk['kondisi']); ?></h5>
            ...
            <div class="col-md-3">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h4><?php echo $perproduk['nama'] ?></h4>
                        <?php if (isset($_SESSION['user'])) { ?>
                        <a href="https://wa.me/08777165392" class="btn btn-primary">Reserve</a>
                        <?php } else { ?>
