...
$koneksi = new mysqli("localhost","u1782530_bngklvirly","bngkl_virly","u1782530_bengkel_virly")
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="indextes.php" style="color: white;">Bengkel Virly</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <!-- Move the form to the right using the 'ms-auto' class -->
                <form action="cari.php" method="get" class="navbar-form d-flex">
                    <!-- Add 'ms-auto' class to the parent div to align its content to the right -->
                    <div class="ms-auto">
                        <a class="btn btn-primary" style="margin-right: 8px;" href="login.php">Login</a>
                        <a class="btn btn-primary" style="margin-right: 8px;" href="register.php">Daftar</a>
                    </div>
                </form>
            </div>
        </div>
