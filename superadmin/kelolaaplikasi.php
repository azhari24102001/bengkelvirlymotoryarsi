...
<body>
    ...
    <div class="buton">
        <div align="center" class="container">
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 btn-container">
                    <a href="dataadmin.php" class="btn btn-primary btn-lg btn-block">Data Admin</a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 btn-container">
                    <a href="datauser.php" class="btn btn-primary btn-lg btn-block">Data User</a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 btn-container">
                    <a href="riwayatsuperadmin.php" class="btn btn-primary btn-lg btn-block">Riwayat Pembelian</a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 btn-container">
